...
export var players:Array<Player>=new Array();
export var bullets:Array<Bullet>=new Array();
...
export class FieldObject{
    ...
    //p: position , d: destination, v:velocity, a:acceleration;
    p:Vector;
    d:Vector;
    v:Vector;
    a:Vector;
    ...
    constructor(x_?:number,y_?:number,v_?:number,a_?:number){
        if(x_===undefined){
            x_=MAIN_WIDTH/2;
        }
        if(y_===undefined){
...
export class Player extends FieldObject{
    ...
    setDestination(coordinationString_:string){
